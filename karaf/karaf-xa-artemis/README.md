...
cp src/main/blueprint/connection-factory.xml $FUSE_HOME/deploy
cp src/main/blueprint/data-source.xml $FUSE_HOME/deploy
install -s mvn:it.fvaleri.integ/karaf-xa-artemis/1.0.0-SNAPSHOT
