...
public class BillboardAggregationTest extends CamelTestSupport {

    private final static String BASE_PATH = System.getProperty("user.dir") + "/target/test-classes/data";
